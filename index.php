...
<body>
  ...
  <div id="pages" data-role="footer" style="text-align:center;margin-bottom:40px;" page="1" mode="1" max="0">
  ...
  <div data-role="footer" id="footer" data-position="fixed" data-fullscreen="true" data-tap-toggle="false">
    <div class="" data-role="navbar">
      <ul>
        <li><a href="index.php" data-ajax='false' data-role="button" data-icon="articleNow" class="ui-icon-article" data-iconpos="notext"></a></li>
        <li><a href="saylove.html" data-ajax='false' data-transition="slide" data-role="button" data-icon="heart" class="ui-icon-heart" data-iconpos="notext"></a></li>
  ...
  <div data-role="popup" class="ui-content" data-overlay-theme="b" id="share-Popup">
    ...
    <div id="link">
      <a href="https://pingxonline.com/app/sust/share.php?id=">https://pingxonline.com/app/sust/share.php?id=</a>
    </div>
  </div>
